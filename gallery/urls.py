...
urlpatterns = [
    ...
    re_path(r'^(\w+)/([\w\-_]+)/edit$', views.edit_gallery),
    re_path(r'^(\w+)/([\w\-_]+)/new$', views.new_work),
    re_path(r'^(\w+)/([\w\-_]+)/([\w\-_]+)$', views.work_page),
    re_path(r'^(\w+)/([\w\-_]+)/([\w\-_]+)/edit$', views.edit_work),
    re_path(r'^(\w+)/([\w\-_]+)/([\w\-_]+)/delete$', views.delete_work),
]
